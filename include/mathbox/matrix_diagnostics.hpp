 ...
 * @param nullspace_threshold threshold for detecting null directions, e.g. `1.0e-9 * eigenvalues.maxCoeff()`
 * @param weak_threshold threshold for detecting weak directions, e.g. `1.0e-4 * eigenvalues.maxCoeff()`
